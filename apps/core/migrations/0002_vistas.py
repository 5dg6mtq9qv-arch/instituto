...
DROP_VIEWS_SQL = """
DROP VIEW IF EXISTS academico.v_indicador_preguntas_docente;
DROP VIEW IF EXISTS cartera.v_cartera_semaforo;
DROP VIEW IF EXISTS matricula.v_ficha_inscripcion;
"""
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(VIEWS_SQL, reverse_sql=DROP_VIEWS_SQL),
    ]
