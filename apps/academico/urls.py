...
urlpatterns = [
    ...
    path("horario-general/", views.HorarioGeneralView.as_view(), name="horario_general"),
    ...
    path("coordinacion/informe-docentes/", views.CoordinacionInformeDocenteView.as_view(), name="coordinacion_informe_docente"),
    ...
    path("docente/calificaciones/", views.DocenteCalificacionesView.as_view(), name="docente_calificaciones"),
    path("docente/calificaciones/<int:materia_curso_pk>/", views.DocenteCalificacionesDetalleView.as_view(), name="docente_calificaciones_detalle"),
    ...
    path("docente/bolsa-recursos/", views.DocenteBolsaRecursosView.as_view(), name="docente_bolsa_recursos"),
    path("docente/bolsa-recursos/<int:pk>/archivo/", views.DocenteBolsaRecursoArchivoView.as_view(), name="docente_bolsa_recurso_archivo"),
