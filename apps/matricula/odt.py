...
def ficha_context(ficha):
    ...
    return {
        ...
        "cliente": ficha.cliente.nombre_completo() if ficha.cliente else "",
        ...
        "estudiante": estudiante.nombre_completo() if estudiante else "",
        ...
        "representante": representante.nombre_completo() if representante else "",
