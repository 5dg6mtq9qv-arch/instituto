...
def ficha_context(ficha):
    ...
    return {
        ...
        "valor_total_curso": formato_moneda(ficha.valor_total_curso),
        "valor_matricula": formato_moneda(ficha.valor_matricula),
        "total": formato_moneda(plan.valor_total if plan else ficha.valor_total_curso + ficha.valor_matricula - ficha.descuento),
        "descuento": formato_moneda(ficha.descuento),
